...
const RED = '#E9041E'
const COLOR = '#6C5CE7'
const LABEL = "Demande d'attestation de travail"

const ITEMS = [
  { id: 1, matricule: 5852, nom: 'Kouakou Marcelle', statut: 'valide',  date: '21 Mai 2026' },
  { id: 2, matricule: 5852, nom: 'Kouakou Marcelle', statut: 'refuse',  date: '21 Mai 2026' },
  { id: 3, matricule: 5852, nom: 'Kouakou Marcelle', statut: 'attente', date: '21 Mai 2026' },
]
...
export default function AttestationsTravail() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-3xl font-bold text-neutral-900">Attestations de travails</h1>
