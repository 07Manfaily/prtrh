...
export default function GestionPortail() {
  ...
  const [event,        setEvent]        = useState({ titre: '', debut: '', fin: '' })
      ...
      <div className="mb-8 rounded-xl border border-neutral-200 bg-white p-6">
        ...
        {activeTab === 'banniere' && (
          <div>
            ...
            >
              <p className="text-sm text-neutral-500">Ajoutez une bannière de taille 1024px x 300px</p>
              <input id="banniere-input" type="file" accept="image/*" className="hidden" />
            </label>
            <div className="flex justify-end">
              <button className="rounded-md px-5 py-2 text-sm font-semibold text-white" style={{ background: DARK }}>
                Uploader
              </button>
            </div>
          </div>
        ...
        {activeTab === 'message' && (
          <div>
            <div className="mb-4">
              <label className="mb-1.5 block text-sm font-medium text-neutral-700">Message de Bienvenue</label>
              <textarea
                value={message}
        ...
        {activeTab === 'media' && (
          <div>
            <div className="mb-4">
              <label className="mb-1.5 block text-sm font-medium text-neutral-700">Type de fichier</label>
              <div className="relative">
                <select
                  value={mediaType}
                  onChange={(e) => setMediaType(e.target.value)}
                  className="w-full appearance-none rounded-lg border border-neutral-200 px-4 py-3 text-sm outline-none focus:border-neutral-400"
                >
                  <option value="">Ex : Image</option>
            ...
            <label
              ...
              htmlFor="media-input"
            >
              <p className="text-sm text-neutral-500">Ajoutez une image</p>
              <input id="media-input" type="file" accept="image/*,video/*" className="hidden" />
            </label>
            <div className="flex justify-end">
              <button className="rounded-md px-5 py-2 text-sm font-semibold text-white" style={{ background: DARK }}>
                Valider
        ...
        {activeTab === 'ip' && (
          <div>
            <div className="mb-4">
              <label className="mb-1.5 block text-sm font-medium text-neutral-700">IP</label>
              <input
                value={ip}
        ...
        {activeTab === 'evenements' && (
          <div>
            <div className="mb-4">
              <label className="mb-1.5 block text-sm font-medium text-neutral-700">Titre évènement</label>
              <input
                value={event.titre}
        ...
        <div className="rounded-xl px-8 py-5" style={{ background: '#fef2f2' }}>
          <p className="text-lg">
            ...
            <span className="text-neutral-700">
              "{flashInfos[0] || 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus.'}"
            </span>
          </p>
        </div>
      )}
      ...
      {activeTab === 'message' && (
        <div className="grid grid-cols-2 overflow-hidden rounded-xl border border-neutral-200">
          <div className="p-8 text-sm leading-relaxed text-neutral-700 whitespace-pre-line">
            {message ||
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspe ndisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor.\n\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspe ndisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor.Lorem ipsum dolor sit amet, consectetur adipiscing elit.'}
          </div>
      ...
      {activeTab === 'media' && (
        <div className="grid grid-cols-2 overflow-hidden rounded-xl border border-neutral-200">
          <div className="p-8 text-sm leading-relaxed text-neutral-700">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspe ndisse lectus tortor,
            dignissim sit amet, adipiscing nec, ultricies sed, dolor.Lorem ipsum dolor sit amet, consectetur
      ...
      {activeTab === 'evenements' && (
        <div className="w-72">
          <div className="overflow-hidden rounded-xl border border-neutral-200 shadow-sm">
            <div className="relative">
              <img src={IMG_EVENT} alt="Event" className="h-44 w-full object-cover" />
              <div
